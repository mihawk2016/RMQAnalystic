...
MetaQuote.Report <- R6Class(
  ...
  public = list(
    ...
    init.tickets = function(tickets.columns) {
      ...
      private$get.html.table.tickets(tickets.columns)
  ...
  private = list(
    ...
    add.tickets.table = function(table, group, columns, uniform.columns) {
      # ''' add tickets table into original tickets '''
      # 2017-01-21: Version 1.0
      if (is.null(self$get.tickets('original'))) {
        private$init.tickets.original()
      }
      private$m.tickets.original$add.table(table, group, columns, uniform.columns)
    } # FINISH
...
MetaQuote.HTML.MT4EA.Report <- R6Class(
  ...
  private = list(
    ...
    get.html.table.tickets = function(tickets.columns) {
